...
DEFAULT_TEXTS = [
    ...
    ("home", "home_notice", "Плашка про конструктор", "✨ Можно собрать свой дизайн в конструкторе: состав набора и цвет гипса на выбор. Форма изделия не меняется. Узоры и эскизы — только из вариантов, которые предлагает мастерская."),
    ...
    ("catalog", "catalog_lead", "Текст каталога", "Розница — одна позиция. Опт: своя цена и заказ от 100 штук."),
    ("constructor", "constructor_title", "Заголовок конструктора", "Конструктор"),
    ("constructor", "constructor_lead", "Текст конструктора", "Меняется состав набора и цвет гипса. Форма изделия остаётся той же. Узоры и эскизы наносятся только из вариантов, которые добавил администратор."),
